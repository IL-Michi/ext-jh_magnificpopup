...
\TYPO3\CMS\Extbase\Utility\ExtensionUtility::configurePlugin(
    ...
    'Pi1', 
    [
            \JonathanHeilmann\jh_magnificpopup\Controller\MagnificpopupController::class =>'show'
			],
			[
            \JonathanHeilmann\jh_magnificpopup\Controller\MagnificpopupController::class => ''
			]
);
